<div align="center">
  <img alt="fish-brew" src="./assets/logo.png" height="200" />
</div>

# fish-brew

A fork of [TacoMilkshake/fish-plugin-brew](https://github.com/TacoMilkshake/fish-plugin-brew) with LinuxBrew support, combined with [ohmyzsh/brew](https://github.com/ohmyzsh/ohmyzsh/tree/master/plugins/brew) ported to the Fish shell.
...
| bcr    | `brew reinstall --cask`                 | Reinstall the given cask.                                             |
...
| bso    | `brew services stop`                    | Stop the service and unregister it from launching at login (or boot). |
| bsoffa | `brew services stop --all`              | Stop all started services.                                            |
